...
def process_prompts(input_file, output_file, start_prompt=164, batch_size=1, alpha=0.7):
...
if __name__ == "__main__":
    ...
    output_file = "rose_implementation_from_164.jsonl"
    
    # Start processing from the 29th prompt
    process_prompts(input_file, output_file, start_prompt=29, alpha=0.7)