...
def process_prompts(input_file, output_file, batch_size=1, alpha=0.7):
...
if __name__ == "__main__":
    ...
    output_file = "rose_full_implementation.jsonl"
    
    # Use alpha=0.7 for classification tasks, alpha=0.5 for generation tasks
